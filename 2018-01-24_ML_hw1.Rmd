...
(b) Well, the only way I know of to test different values of the parameter $\eta$ is to make a list of possible values and throw them all into the function to see which one gives the best accuracy at the end. Or, as I like to call it, the "head meet wall repeatedly" method.  
